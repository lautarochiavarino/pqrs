...
class PqrsOpenExport implements FromCollection, WithHeadings, WithTitle, WithEvents
{
    /**
    ...
    */
    public function collection()
    {
        $sql = DB::table('pqrs')
            ...
            ->select('pqrs.id','aSuNombre','formatoRecepcion','tipoSolicitud','tipoSolicitante_id',
                ...
                'grupo.subserie','pqrs.created_at','tiempoRespuesta','nuevaGestion','pqrs.respuestaPreliminar','pqrs.respuestaFinal','pqrs.consecutivoCorrespondencia')
            ->where('pqrs.estado','=', 1)
            ->get();
    ...
    {
        return 'Reporte de Pqrs Abiertas';
    }
