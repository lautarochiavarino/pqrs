...
.alert {
    ...
    <script type="text/javascript">
        if(navigator.userAgent.indexOf('MSIE')!==-1
            ...
            alert("Este formulario debe ser diligencia en los siguientes exploradores: Chrome, Firefox, o Microsoft Edge");
        }
...
<div class="form-group adjuntarpqrs">
                                                        <div class="form-row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <p>Tamaño máximo 50MB. Formatos permitidos: .jpeg, .jpg, .png, .gif, .doc, .pdf, .xls, .docx, .xlsx, .odt, .ods, .msg</p>
                                                                <dd><div class="form-label-group" id="adjuntos">

                                                                    <label for="file-upload" class="subir">
                                                                        <i class="fas fa-cloud-upload-alt"></i> Subir archivo
                                                                    </label>
                                                                                                                                    
                                                                    <input type="file" name="archivospqrs[]" id="file-upload" onchange='cambiar()' style='cursor: pointer;' accept="application/pdf, .doc, .docx, .odf, .xls, .xlsx, .msg, image/png, .jpeg, .jpg, image/gif"/>

<div id="info"></div>   
                                                                    <!-- Funcion para cambiar el input -->
                                                               ...
                                                               <div id="ancla"> <a href="#ancla" onClick="addCampo()">Agregar otro archivo</a></div>
                                                            </div>
                                                        </div>
                                                    </div>
