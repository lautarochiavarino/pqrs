                            ...
                            <div class="elementor-column-wrap elementor-element-populated">
                                <div class="elementor-widget-wrap">
                                    ...
                                    <div data-id="2942c237" class="elementor-element elementor-element-2942c237 textos elementor-widget elementor-widget-heading" data-element_type="heading.default">
                                        <div class="elementor-widget-container">
                                            <h1 class="elementor-heading-title elementor-size-medium">Bienvenidos</h1>		</div>
                                    </div>
                                    <div data-id="288ad84" class="elementor-element elementor-element-288ad84 textos elementor-widget elementor-widget-heading" data-element_type="heading.default">
                                        <div class="elementor-widget-container">
                                            <h1 class="elementor-heading-title elementor-size-medium">Somos la energía
                                            </h1>		</div>
                                    </div>
                                    <div data-id="005b0a3" class="elementor-element elementor-element-005b0a3 textos elementor-widget elementor-widget-heading" data-element_type="heading.default">
                                        <div class="elementor-widget-container">
                                            <p class="elementor-heading-title elementor-size-medium">Ingrese su número de PQRS para conocer su estado. </p>
                                    ...
                                    <form method="POST" action="{{url('detallepqrs')}}">
                                        {{csrf_field()}}
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="form-label-group">
                                                        <input type="text" id="seguimiento" class="form-control" placeholder="Número de su PQRS" required="required" autofocus="autofocus" name="seguimiento">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-label-group">
                                                        <input type="text" id="email" class="form-control" placeholder="Ingrese el código de validación" required="required" autofocus="autofocus" name="codigo">
