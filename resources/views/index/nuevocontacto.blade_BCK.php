...
<html class=" background-fixed" lang="es-ES"><head>
    ...
    border-radius: 5px;
        ...
        .titulos p {
   border-bottom: 1px solid #0877BE;
    padding-bottom: 5px;
    margin-bottom: 20px;
    border-top: 1px solid #0877be;
    padding-top: 5px;
margin-top: 40px;
...
<div class="labels">Nombre <span>*</span></div>
                                                                ...
                                                                <label for="contacto">Ingrese su nombre y apellido</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<div class="labels">Seleccione un País <span>*</span></div>
                                                                <div class="form-label-group">
                                                                    {!! Form::select('pais_id', $paises,null,['id'=>'pais', 'placeholder' => 'Seleccione']) !!}
                                                                </div>
                                                            </div>
...
<div class="labels">Correo Electrónico</div>
                                                            ...
                                                            <div class="col-md-6">
<div class="labels">Provincia/Estado/Departamento <span>*</span></div>
                                                                <div class="form-label-group">
                                                                    {!! Form::select('provincia_id',['placeholder'=>'Seleccione'],null,['id'=>'provincia']) !!}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<div class="labels">Dirección Física</div>
                                                                <div class="form-label-group">
                                                                    ...
                                                                    <label for="direccionFisica">Ingrese una Dirección Física</label>
                                                                </div>
                                                            </div>

                                                            <div class="col-md-6">
<div class="labels">Ciudad/Municipio <span>*</span></div>
                                                                <div class="form-label-group">
                                                                    
                                                                    <input id="ciudad" class="form-control" placeholder="Ciudad/Municipio*" autofocus name="ciudad" type="text" required>
                                                                    <label for="ciudad">Ingrese Ciudad/Municipio</label>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <label for="breveDescripcion"><div class="labels">Tipo de Solicitud PQRS <span>*</span></div></label>
                                                                <div class="form-label-group">
