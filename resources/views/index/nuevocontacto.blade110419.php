...
.alert {
    ...
    <script type="text/javascript">
        if(navigator.userAgent.indexOf('MSIE')!==-1
            ...
            alert("El formulario puede no funcionar correctamente con Internet Explorer");
        }
...
<div class="form-group adjuntarpqrs">
                                                        <div class="form-row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <p>Tamaño máximo 50MB. Formatos permitidos: .jpeg, .jpg, .png, .gif, .doc, .pdf, .xls, .docx, .xlsx, .odt, .ods</p>
                                                                <dd><div class="form-label-group" id="adjuntos">


                                                                    <input type="file" name="archivospqrs[]">


                                                                    </div></dd>
                                                                <a href="#" onClick="addCampo()">Agregar otro archivo</a>
                                                            </div>
                                                        </div>
                                                    </div>
